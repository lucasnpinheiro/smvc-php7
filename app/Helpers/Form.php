...
class Form {
	 ...
	 *
	 * @param
	 *        	array(id, name, class, onsubmit, method, action, files, style)
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(id, name, class, onclick, columns, rows, disabled, placeholder, style, value)
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(id, name, class, onclick, value, length, width, disable,placeholder)
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(id, name, class, onclick, disabled)
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(array(id, name, value, class, checked, disabled))
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(array(id, name, value, class, checked, disabled, label))
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	array(id, name, class, onclick, value, disabled)
	 *        	
	 * @return string
	 */
