...
class Arrays
{
    ...
    /**
     * Search for an array value.
     * Returns TRUE if the array key exists and FALSE if not.
     *
     * @param array $array            
     * @param string $path            
     *
     * @return bool
     */
    public static function has(array $array, $path): bool
    {
        $segments = explode('.', $path);
     ...
     *
     * @param array $array
     *            Array you want to modify
     * @param string $path
     *            Array path
     *            
     * @return boolean
     */
    public static function remove(array &$array, $path): bool
    {
        $segments = explode('.', $path);
        while (count($segments) > 1) {
            $segment = array_shift($segments);
     ...
     *
     * @param array $array
     *            Array you want to pick a random value from
     *            
     * @return mixed
     */
     ...
     * @return array
     */
    public static function value(array $array, $key): array
    {
