...
class Validator
{
    ...
    {
        $message = $this->_getDefaultMessage(__FUNCTION__, array(
            $min,
            $max,
            $include
        ));
    ...
    {
        $message = empty($message) ? self::getDefaultMessage(__FUNCTION__, array(
            $minlength,
            $maxlength
        )) : NULL;
    ...
    public function guid($message = null): this
    {
        $this->setRule(__FUNCTION__, function ($val) {
     ...
     * @return boolean
     */
    public static function isEmail($emailID): bool
    {
    ...
    public static function isString($text, $onlyAlphabets = false): bool
    {
        if ($onlyAlphabets)
    ...
    public static function isNumber(&$number, $checkIntFloat = false): bool
    {
        if ($checkIntFloat)
    ...
    public static function isGUID($string): bool
    {
