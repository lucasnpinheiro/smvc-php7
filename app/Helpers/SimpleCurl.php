...
class SimpleCurl {
	...
	public static function get($url, $params = []) {
		...
		$options = array (CURLOPT_URL => $url,CURLOPT_RETURNTRANSFER => true,CURLOPT_CONNECTTIMEOUT => 10,CURLOPT_SSL_VERIFYPEER => false);
	...
	public static function post($url, $fields = []) {
		...
		$options = array (CURLOPT_URL => $url,CURLOPT_RETURNTRANSFER => true,CURLOPT_CONNECTTIMEOUT => 10,CURLOPT_SSL_VERIFYPEER => false,CURLOPT_POSTFIELDS => $fields,CURLOPT_POST => true,CURLOPT_USERAGENT => "SMVC Agent");
		curl_setopt_array($ch, $options);
	...
	public static function put($url, $fields = []) {
		...
		$options = array (CURLOPT_RETURNTRANSFER => true,CURLOPT_CONNECTTIMEOUT => 10,CURLOPT_SSL_VERIFYPEER => false,CURLOPT_CUSTOMREQUEST => "PUT",CURLOPT_POSTFIELDS => $post_field_string);
		curl_setopt_array($ch, $options);
