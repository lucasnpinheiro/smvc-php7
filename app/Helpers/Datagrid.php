...
class Datagrid {
	...
	public function __construct() {
		...
		$this->noDataMessage = \Helpers\BootstrapUI::alertBox('No records to display');
	...
	private function _validate() {
		...
		$this->border = ! empty($this->border) ? $this->border : 0;
		$this->padding = ! empty($this->padding) ? $this->padding : 4;
		$this->spacing = ! empty($this->spacing) ? $this->spacing : 0;
